        ...
        <div class="col-md-9 col-lg-9 col-sm-8 col-xs-12 float-left-style">
            ...
            <div class="slider__container slider--one">
                <div class="slider__activation__wrap owl-carousel owl-theme">
                    @foreach ($latest_products as $last_product)
                        <!-- Start Single Slide -->
                        <div class="slide slider__full--screen slider-height-inherit  slider-text-left"
                            style="background: rgba(0, 0, 0, 0)
        url('{{ asset('uploads/images/' . $last_product->image) }}')
        no-repeat scroll center center / cover;">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                                        <div class="slider__inner">
                                            <h1> {{ $last_product->name }} <span
                                                    class="text--theme">{{ $last_product->parentCategory->name }}</span>
                                            </h1>
                                            <div class="slider__btn">
                                                <a class="htc__btn"
                                                    href="{{ route('web.product', $last_product->id) }}">shop now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="col-md-3 col-lg-3 col-sm-4 col-xs-12 float-right-style">
            <div class="categories-menu mrg-xs">
                <div class="category-heading">
                    <h3> {{ __('site.Browse Categories') }}</h3>
                </div>
                <div class="category-menu-list">
                    <ul>
                        @foreach ($main_categories as $m_category)
                            ...
                            @endif
                            <li><a
                                    @if (!$has_dropDown) href="{{ route('web.category', $m_category->id) }}" @endif><img
                                ...
                                @if ($has_dropDown)
                                    <div class="category-menu-dropdown">
                                        <div class="category-part-1 category-common mb--30">
                                            <ul>
                                                @foreach ($m_category->children as $c_item)
                                                    <li><a href="{{ route('web.category', $c_item->id) }}">
                                                            {{ $c_item->name }}</a></li>
                                                @endforeach
                                            </ul>
                                        </div>
