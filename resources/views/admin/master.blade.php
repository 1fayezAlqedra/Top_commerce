...
<head>
    ...
    <link rel="icon"
        href="{{ asset('adminasset/img/ecommerce-global-shopping-icon-isolated-600nw-2058092813.webp') }}">
    @yield('styles')
...
<body id="page-top">
    ...
    <script src="{{ asset('wysiwyg/tinymce/js/tinymce/tinymce.min.js') }}"></script>
    <script>
