            ...
            <div class="user_options-text">
                <div class="user_options-unregistered">
                    ...
                    <form action="{{ route('register') }}" method="post">
                        @csrf
                        <a class="user_unregistered-signup" id="signup-button" href="{{ route('register') }}">Sign up<a>
                    ...
                    <form class="forms_form" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="forms_buttons">
                            <button type="submit" class="forms_buttons-action">
                                {{ __('Login') }}
                            </button> <input class="forms_buttons-action" type="checkbox" name="remember" id="remember"
